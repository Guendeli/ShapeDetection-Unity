...
namespace ShapeDetector {
    public class ShapeLibrary {
        ...
        List<Shape> library = new List<Shape>();

        public List<Shape> Library { get { return library; } }


        public ShapeLibrary(string libraryName, bool forceCopy = false) {
        ...
        public void LoadLibrary() {
            ...
            foreach (XmlNode xmlGestureNode in xmlGestureList) {
                ...
                Shape gesture = new Shape(gesturePoints, gestureName);
                library.Add(gesture);
            }
        }
        ...
        public bool AddGesture(Shape gesture) {
